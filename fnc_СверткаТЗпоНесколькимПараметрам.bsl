...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Свертка более чем по 2-м параметрам
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function fnc_СверткаТЗпоНесколькимПараметрам( a_tValueTable, a_listParameters, a_keyParameter, a_columnsValues, a_columnSum )
	...
	//свертка по a_keyParameter для расчета сумм
	a_tValueTable_temp_keyParameter = a_tValueTable.Скопировать();
	...
	Для каждого elm из a_tValueTable_temp_keyParameter цикл
		...
		НайденныеСтроки = a_tValueTable.НайтиСтроки(Отбор);
